...
# test helpers
from tests.common_util import TEST_IMAGE_DIR, TEST_IMAGE_JPG, et_get_temp_dir
...
class TestHelperFloatTags(unittest.TestCase):
    ...
    def setUp(self):
        self.et = exiftool.ExifToolHelper(
            common_args=["-n", "-overwrite_original"], encoding="UTF-8"
        )
        ...
        self.test_data_str = [
            ...
            [
                {
                    "Comment": Decimal(
                        "935733.817019799357333475932629142801644788893573383506621454627967"
                    )
                },
                "935733.817019799357333475932629142801644788893573383506621454627967",
            ],
    ...
    def test_baseline_exiftool_behavior(self):
        ...
        test_data = [
            ...
            [
                {"Comment": "   1      "},
                "  1      ",
            ],  # exiftool removes a space (might be an exiftool bug)  TODO more investigation on this specific case, and report bug if it is
            ...
            [{"FocalLength": "01.0"}, 1],
            [
                {"FocalLength": "blahblahblah"},
                1,
            ],  # this is ignored by exiftool, so it uses previous set value
            ...
            [{"Comment": "-1.10"}, -1.1],
            [{"Comment": "0.1000"}, 0.1],
            [{"Comment": "1.337e+40"}, 1.337e40],
            [{"Comment": "1.33700e+40"}, 1.337e40],
            [
                {"Comment": Decimal("935733.81701979935")},
                935733.8170197994,
            ],  # notice that exiftool rounds here
        ]
