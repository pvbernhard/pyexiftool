...
class ExifToolHelper(ExifTool):
    ...
    def execute(self, *params: Any, **kwargs) -> Union[str, bytes]:
        ...
        str_bytes_params: Union[str, bytes] = [
            x if isinstance(x, TUPLE_STR_BYTES) else str(x) for x in params
        ]
    ...
    # ----------------------------------------------------------------------------------------------------------------------
    def get_metadata(
        self, files: Union[str, List], params: Optional[Union[str, List]] = None
    ) -> List:
        """
    ...
    def get_tags(
        ...
        if tags is None:
            ...
            raise TypeError(
                f"{self.__class__.__name__}.get_tags: argument 'tags' must be a str/bytes or a list"
            )
    ...
    def set_tags(
        ...
        if not tags:
            raise ValueError(
                f"{self.__class__.__name__}.set_tags: argument 'tags' cannot be empty"
            )
        elif not isinstance(tags, dict):
            raise TypeError(
                f"{self.__class__.__name__}.set_tags: argument 'tags' must be a dict"
            )
