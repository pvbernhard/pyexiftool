...
class ExifToolExecuteError(ExifToolExecuteException):
    ...
    def __init__(self, exit_status, cmd_stdout, cmd_stderr, params):
        super().__init__(
            f"execute returned a non-zero exit status: {exit_status}",
            exit_status,
            cmd_stdout,
            cmd_stderr,
            params,
...
class ExifToolOutputEmptyError(ExifToolExecuteException):
    ...
    def __init__(self, exit_status, cmd_stdout, cmd_stderr, params):
        super().__init__(
            "execute_json expected output on stdout but got none",
            exit_status,
            cmd_stdout,
            cmd_stderr,
            params,
...
class ExifToolJSONInvalidError(ExifToolExecuteException):
    ...
    def __init__(self, exit_status, cmd_stdout, cmd_stderr, params):
        super().__init__(
            "execute_json received invalid JSON output from exiftool",
            exit_status,
            cmd_stdout,
            cmd_stderr,
            params,
